...
import 'package:my_home/core/custom_widgets/request_visit_dialog.dart';
import 'package:my_home/core/custom_widgets/visitors_list_dialog.dart';
                      ...
                      Stack(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: (logic.product?.images?.length ?? 0) != 0
                                  ? ListView.builder(
                                      shrinkWrap: true,
                                      physics:
                              ...
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: CustomButton(
                                    ...
                                    isEnabled:
                                        !(logic.product?.isBooked ?? false) ||
                                            logic.product?.whoBooked ==
                                                logic.localSource
                                                    .getProfile()
                                                    .username,
                                    onPressed: () async {
                                      await logic.bookProduct(
                                          !(logic.product?.isBooked ?? false));
                                    },
                                  ),
                                ),
                                  ...
                                  child: CustomButton(
                                    ...
                                    onPressed: () {
                                      showDialog(
                                        ...
                                        barrierColor: Colors.transparent,
                                        builder: (_) {
                                          return VisitorsListDialog(
                                            visitors: logic.allVisitors,
                                          );
                                        },
                                      );
                                    },
